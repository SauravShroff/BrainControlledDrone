...
private:
    float getMappedValue(AxisMap::AxisType axis_type, const AxisMap& map, const DirectInputJoyStick::JoystickState& di_state, const std::string& device_pid_vid)
    {
        ...
        if (map.rc_axis == AxisMap::AxisType::Auto) {
            if (device_pid_vid == "" || device_pid_vid == "VID_0483&PID_5710") { //RCs like FrSky Taranis
                ...
                //case AxisMap::AxisType::LeftX: rc_axis = AxisMap::AxisType::LeftX; break;
                //case AxisMap::AxisType::LeftY: rc_axis = AxisMap::AxisType::LeftY; break;
                //case AxisMap::AxisType::LeftZ: rc_axis = AxisMap::AxisType::LeftZ; break;
                //case AxisMap::AxisType::RightX: rc_axis = AxisMap::AxisType::RightX; break;
                //case AxisMap::AxisType::RightY: rc_axis = AxisMap::AxisType::RightY; break;
                //case AxisMap::AxisType::RightZ: rc_axis = AxisMap::AxisType::RightZ; break;
                default:
        ...
        switch (rc_axis)
        {
        // LeftX:                            di_state.x:  Rotation Hardware (rev)
        // LeftY:                            di_state.y:  Throttle Hardware
        // LeftZ:                            di_state.z:  L/R Bank Hardware
        // RightX:                           di_state.rx: F/B Pitch Hardware 
        // RightY:                           di_state.ry: NO CTRL HARDWARE CONNECTION
        // RightZ                            di_state.rz
   

            
        case AxisMap::AxisType::LeftX: result = 1 - di_state.x; break; //3
        case AxisMap::AxisType::LeftY: result = 1 - di_state.z; break; //4
        case AxisMap::AxisType::LeftZ: result = di_state.rx; break;
        case AxisMap::AxisType::RightX: result = di_state.y; break;
        case AxisMap::AxisType::RightY: result = 0; break;
        case AxisMap::AxisType::RightZ: result = 0; break;
    ...
    float getAxisValue(AxisMap::AxisType axis_type, const AxisMap& map, const DirectInputJoyStick::JoystickState& di_state, const std::string& device_pid_vid)
    {
        ...
        case AxisMap::AxisType::LeftY:
            axis_type = AxisMap::AxisType::LeftX;
            break; //optional
